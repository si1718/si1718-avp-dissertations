(function() {
    ...
    DissertationsEditController.$inject = ["$scope", "$http", "$stateParams", "$rootScope", "$location", "$uibModal", "$state", "Notification", 'authService'];

    function DissertationsEditController($scope, $http, $stateParams, $rootScope, $location, $modal, $state, Notification, authService) {
        var vm = this;
